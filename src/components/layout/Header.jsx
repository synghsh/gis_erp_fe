...
export const Header = ({ onMenuToggle, breadcrumbItems = [] }) => {
    ...
    <header className="app-header">
      <div className="header-left">
        ...
        <button
          ...
          style={{ display: 'none' }} /* Hidden on desktops, handled by media queries */
      ...
      <div className="header-right">
        ...
        <div className="header-user-menu" ref={dropdownRef}>
          ...
          >
            ...
            <div className="user-info" style={{ display: 'none' }}> {/* Hidden on small screens */}
