...
import { Plus, Edit2, ShieldAlert, Check, X, RefreshCw, UserCheck } from 'lucide-react';
...
export const UserDetailsPage = () => {
  ...
  const roles = useSelector((state) => state.masterData.roles);
  ...
  const handleAssignRoleClick = (item) => {
    setActiveItem(item);
